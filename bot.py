...
async def _(event):
    ...
    buttons=[Button.url("🤝Main Group🛰️", url="t.me/danuma01"), Button.url("📝Bot News🛸", url="https://t.me/Dbotai")],
    buttons=[Button.url("✈️Developer✈️", url="https://lasiya.ml")Button.url("🤙 Contact Dev 🛶", url="https://t.me/Danuma_admin_bot")], link_preview=True)
